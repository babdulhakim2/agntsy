...
import type { AgentCUser } from './agentc/types';
...
export interface MoltbotEnv {
  ...
  AGENTC_DB: D1Database; // D1 database for Agent C multi-user data
  AGENTC_JWT_SECRET?: string; // JWT signing secret for Agent C sessions
